                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('birth_date') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="date" placeholder="Enter a Birth Date"
                                           id="birth_date" name="birth_date" value="{{ $user->birth_date }}">
                                    @error('birth_date')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="@error('country_id') border border-danger rounded-3 @enderror">
                                    <select class="form-control" id="country_id" name="country_id">
                                        ...
                                        @foreach($countries as $id => $name)
                                            <option value="{{ $id }}" @if($user->country_id === $id) selected @endif>{{ $name }}</option>
                                        @endforeach
                                    </select>
                                    @error('country_id')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                ...
                                <div class="@error('role_id') border border-danger rounded-3 @enderror">
                                    <select class="form-control" id="role_id" name="role_id">
                                        ...
                                        @foreach($roles as $id => $name)
                                            <option value="{{ $id }}" @if($user->role_id === $id) selected @endif>{{ $name }}</option>
                                        @endforeach
                                    </select>
                                    @error('role_id')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
