        ...
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('admin.questions.update') }}" method="POST" role="form text-left">
                    ...
                    @endif
                    <div class="row">
                        <input class="form-control" type="hidden" name="course_id" value="{{ $question->course_id }}">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="@error('quiz.description')border border-danger rounded-3 @enderror">
                                    <textarea class="form-control" id="quiz-description" name="description">{{ $question->description }}</textarea>
                                    @error('description')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
