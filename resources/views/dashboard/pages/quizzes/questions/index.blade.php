                ...
                <div class="card mb-4 mx-4">
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            <a href="{{ route('admin.questions.create', $quizId) }}" class="btn bg-gradient-primary btn-sm mb-0"
                               type="button">
                                +&nbsp; New Question
                            </a>
                        </div>
                            ...
                            <table id="myDataTable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                @foreach ($questions as $question)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.question.answers', $question->id) }}" class="mx-3"
                                               data-bs-toggle="tooltip"
                                               data-bs-original-title="Show Question Answers">
                                                <i class="fas fa-tasks text-secondary" aria-hidden="true"></i>
                                            </a>
                                            <a href="{{ route('admin.questions.edit', $question->id) }}" class="mx-3"
                                               data-bs-toggle="tooltip" data-bs-original-title="Edit Question">
                                                <i class="fas fa-edit text-secondary"></i>
                                            </a>
                                            <a href="{{ route('admin.questions.destroy', $question->id) }}"
                                               class="mx-3" data-bs-toggle="tooltip"
                                               data-bs-original-title="Delete Question">
